...
def load_data():
    ...
    train_data = np.load(DATA_DIR / 'train_electricity.npy')
    val_data = np.load(DATA_DIR / 'val_electricity.npy')
    test_data = np.load(DATA_DIR / 'test_electricity.npy')
...
def main():
    ...
    callback = CustomCallback(
        ...
        d_epochs=config.get('d_epochs', 5),  # Number of batches to process
