...
def load_data():
    ...
    train_data = np.load(DATA_DIR / 'train_electricity_200_250.npy')
    val_data = np.load(DATA_DIR / 'val_electricity_200_250.npy')
    test_data = np.load(DATA_DIR / 'test_electricity_200_250.npy')
